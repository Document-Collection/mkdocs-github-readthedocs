...
偶然在网上找到一篇文章 - [Markdown+Pandoc+Sphinx+ Git 协作写书式推进团队技术文章](https://www.cnblogs.com/yinghao1991/p/6535911.html)，里面提到了一个工具`pandoc`，在网上搜索了其他文章 - [文件格式转换神器-pandoc](https://www.cnblogs.com/yinghao1991/p/6535911.html)
，发现这是一个通用的文档转换器
